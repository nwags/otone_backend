...
class Subscriber():
    ...
    * 'save_protocol' : lambda self.save_protocol(data)
...
#Special Methods
    ...
    def create_deck(self, data):
        ...
        if debug == True and verbose == True: FileIO.log('pre-call self.caller.publish() ',json.dumps(msg,sort_keys=True,indent=4,separators=(',',': ')),'\n')
        self.caller.publish('com.opentrons.robot_to_browser',json.dumps(msg,sort_keys=True,indent=4,separators=(',',': ')))
    ...
    def wifi_scan(self, data):
        ...
        self.caller.publish('com.opentrons.robot_to_browser',json.dumps(ws,sort_keys=True,indent=4,separators=(',',': ')))
