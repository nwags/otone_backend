...
#OTHER DATA NEEDING TO GO BACK TO UI
    ...
    def send_message(self,type_,damsg):
        ...
        try:
            #self.caller._myAppSession
            self.caller.publish('com.opentrons.robot_to_browser',json.dumps(msg))
        except:
    ...
    def send_ctrl_message(self,type_,damsg):
        ...
        self.caller.publish('com.opentrons.robot_to_browser_ctrl',json.dumps(msg))
